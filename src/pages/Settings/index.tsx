    ...
    <div data-testid="settings-page" className="flex flex-col -m-6 dark:bg-background h-[calc(100vh-2.5rem)] overflow-hidden">
      <div className="w-full max-w-5xl mx-auto flex flex-col h-full p-10 pt-16">
        ...
        <div className="bajo-page-header mb-8 shrink-0 px-6 py-5">
          <div>
            <div className="bajo-page-kicker mb-2">BAJOCLAW SETTINGS</div>
            ...
            <div className="space-y-3 text-[14px] text-muted-foreground">
              ...
              <div className="flex gap-4 pt-3">
                <Button
                  ...
                  onClick={() => window.electron.openExternal('https://www.bajoseek.com/')}
                >
                  {t('about.docs')}
                </Button>
                <Button
                  variant="link"
                  className="h-auto p-0 text-[14px] text-blue-500 hover:text-blue-600 font-medium"
                  onClick={() => window.electron.openExternal('https://github.com/bajoseek/openclaw-bajoseek')}
                >
                  {t('about.github')}
                </Button>
                <Button
