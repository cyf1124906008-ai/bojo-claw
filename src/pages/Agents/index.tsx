      ...
      <div className="w-full max-w-5xl mx-auto flex flex-col h-full p-10 pt-16">
        <div className="bajo-page-header mb-8 shrink-0 px-6 py-5">
          ...
          <div>
            ...
            <p className="max-w-2xl text-[14px] font-medium leading-6 text-foreground/70">{t('subtitle')}</p>
          </div>
...
function AddAgentDialog({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4">
      <Card className="w-full max-w-md rounded-lg border border-black/10 dark:border-white/10 shadow-2xl bg-[#f3f1e9] dark:bg-card overflow-hidden">
        ...
        <CardContent className="space-y-6 pt-4 p-6">
          ...
          <div className="flex justify-end gap-2">
            <Button
              variant="outline"
              onClick={onClose}
              className="h-9 text-[13px] font-semibold rounded-md px-4 border-black/10 dark:border-white/10 bg-transparent hover:bg-black/5 dark:hover:bg-white/5 shadow-none text-foreground/80 hover:text-foreground"
            >
...
function AgentModelModal({
  ...
  return (
    <div className="fixed inset-0 z-[60] bg-black/50 flex items-center justify-center p-4">
      <Card className="w-full max-w-xl rounded-lg border border-black/10 dark:border-white/10 shadow-2xl bg-[#f3f1e9] dark:bg-card overflow-hidden">
