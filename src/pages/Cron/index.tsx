...
function TaskDialog({ job, configuredChannels, onClose, onSave }: TaskDialogProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4" onClick={onClose}>
      <Card className="w-full max-w-lg max-h-[90vh] flex flex-col rounded-lg border border-black/10 dark:border-white/10 shadow-2xl bg-[#f3f1e9] dark:bg-card overflow-hidden" onClick={(e) => e.stopPropagation()}>
        <CardHeader className="flex flex-row items-start justify-between pb-2 shrink-0">
          <div>
            <CardTitle className="text-2xl font-bold">{job ? t('dialog.editTitle') : t('dialog.createTitle')}</CardTitle>
        ...
        <div className="bajo-page-header mb-8 shrink-0 px-6 py-5">
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              className="h-9 rounded-md border-black/10 bg-white/40 px-4 text-[13px] font-semibold text-foreground/80 shadow-none hover:bg-white/70 dark:border-white/10 dark:bg-white/5 dark:hover:bg-white/10"
            >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            <div className="bajo-card-hover p-5 flex flex-col justify-between min-h-[130px] relative overflow-hidden group transition-colors">
              ...
              <div className="mt-4 flex items-baseline gap-3">
                <p className="text-[36px] leading-none font-bold text-foreground">{safeJobs.length}</p>
            ...
            <div className="bajo-card-hover p-5 flex flex-col justify-between min-h-[130px] relative overflow-hidden group transition-colors">
              ...
              <div className="mt-4 flex items-baseline gap-3">
                <p className="text-[36px] leading-none font-bold text-foreground">{activeJobs.length}</p>
            ...
            <div className="bajo-card-hover p-5 flex flex-col justify-between min-h-[130px] relative overflow-hidden group transition-colors">
              ...
              <div className="mt-4 flex items-baseline gap-3">
                <p className="text-[36px] leading-none font-bold text-foreground">{pausedJobs.length}</p>
            ...
            <div className="bajo-card-hover p-5 flex flex-col justify-between min-h-[130px] relative overflow-hidden group transition-colors">
              ...
              <div className="mt-4 flex items-baseline gap-3">
                <p className="text-[36px] leading-none font-bold text-foreground">{failedJobs.length}</p>
