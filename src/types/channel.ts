...
export const CHANNEL_META: Record<ChannelType, ChannelMeta> = {
  bajoseek: {
    ...
    docsUrl: 'channels:meta.bajoseek.docsUrl',
    configFields: [
      {
        key: 'botId',
        label: 'channels:meta.bajoseek.fields.botId.label',
        type: 'text',
        placeholder: 'channels:meta.bajoseek.fields.botId.placeholder',
        required: true,
        envVar: 'BAJOSEEK_BOT_ID',
      },
      {
        key: 'token',
        label: 'channels:meta.bajoseek.fields.token.label',
        type: 'password',
        placeholder: 'channels:meta.bajoseek.fields.token.placeholder',
        required: true,
        envVar: 'BAJOSEEK_TOKEN',
      },
    ],
    instructions: [
      'channels:meta.bajoseek.instructions.0',
      'channels:meta.bajoseek.instructions.1',
      'channels:meta.bajoseek.instructions.2',
    ],
    isPlugin: true,
  },
  qqbot: {
